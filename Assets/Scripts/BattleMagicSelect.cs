...
public class BattleMagicSelect : MonoBehaviour {
    ...
    public void Press()
    {
        if (BattleManager.instance.activeBattlers[BattleManager.instance.curretTurn].currentMP >= spellCost)
        {
            BattleManager.instance.magicMenu.SetActive(false);
            BattleManager.instance.OpenTargetMenu(spellName);
            BattleManager.instance.activeBattlers[BattleManager.instance.curretTurn].currentMP -= spellCost;
        }else
        {
